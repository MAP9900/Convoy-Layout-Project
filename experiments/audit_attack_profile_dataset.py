...
def flatten_dataset_records(records: Iterable[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    for record in records:
        ...
        row = {
            ...
            "aim_offset_kind": str(intent.get("aim_offset_kind", audit.get("aim_offset_kind", ""))),
            "aim_lateral_offset_m": float(intent.get("aim_lateral_offset_m", audit.get("aim_lateral_offset_m", 0.0))),
            "aim_offset_side": int(intent.get("aim_offset_side", audit.get("aim_offset_side", 0))),
            "n": int(profile["n"]),
