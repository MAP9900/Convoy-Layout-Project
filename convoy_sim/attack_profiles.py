...
def build_scaffolded_attack_profile_library() -> AttackProfileLibrary:
    ...
    profiles = [
        ...
        AttackProfile(profile_id="P14", name="profile_14", mode="fan", u_pos=(-300.0, 700.0), n=4, speed=15.4333, max_run_time=486.0, base_bearing_rad=4.97418836818, spread_rad=0.0873, bearing_rad=0.0, lateral_spacing=120.0, launch_delay_s=1.3, salvo_interval_s=2.0),
        AttackProfile(profile_id="P15", name="profile_15", mode="fan", u_pos=(100.0, -900.0), n=4, speed=15.4333, max_run_time=486.0, base_bearing_rad=1.3089969390, spread_rad=0.0873, bearing_rad=0.0, lateral_spacing=120.0, launch_delay_s=2.4, salvo_interval_s=3.0),
        AttackProfile(profile_id="P16", name="profile_16", mode="fan", u_pos=(400.0, 900.0), n=4, speed=15.4333, max_run_time=486.0, base_bearing_rad=4.81038, spread_rad=0.0698, bearing_rad=0.0, lateral_spacing=120.0, launch_delay_s=0.6, salvo_interval_s=0.0),
        ...
        AttackProfile(profile_id="P18", name="profile_18", mode="fan", u_pos=(250.0, -2500), n=4, speed=15.4333, max_run_time=486.0, base_bearing_rad=1.5708, spread_rad=0.0873, bearing_rad=0.0, lateral_spacing=120.0, launch_delay_s=1.0, salvo_interval_s=2.0),
        ...
        AttackProfile(profile_id="P20", name="profile_20", mode="fan", u_pos=(350.0, -2100.0), n=4, speed=15.4333, max_run_time=486.0, base_bearing_rad=1.44862, spread_rad=0.0698, bearing_rad=0.0, lateral_spacing=120.0, launch_delay_s=1.9, salvo_interval_s=2.0),
        AttackProfile(profile_id="P21", name="profile_21", mode="fan", u_pos=(0.0, 1100.0), n=4, speed=15.4333, max_run_time=486.0, base_bearing_rad=5.23599, spread_rad=0.1047, bearing_rad=0.0, lateral_spacing=120.0, launch_delay_s=1.4, salvo_interval_s=2.0),
        ...
        AttackProfile(profile_id="P23", name="profile_23", mode="fan", u_pos=(-3200.0, 900.0), n=4, speed=15.4333, max_run_time=486.0, base_bearing_rad=5.81195, spread_rad=0.0873, bearing_rad=0.0, lateral_spacing=120.0, launch_delay_s=0.5, salvo_interval_s=3.0),
        ...
        AttackProfile(profile_id="P25", name="profile_25", mode="fan", u_pos=(3600.0, -1100), n=4, speed=15.4333, max_run_time=486.0, base_bearing_rad=2.35619, spread_rad=0.0698, bearing_rad=0.0, lateral_spacing=120.0, launch_delay_s=2.0, salvo_interval_s=3.0),
    ]
    return AttackProfileLibrary(profiles=profiles)
