...
def build_scaffolded_attack_profile_library() -> AttackProfileLibrary:
    ...
    profiles = [
        ...
        _scaffolded_fan_profile(profile_id="P35", name="profile_35_east_abeam_close_uniform_narrow_4", u_pos=(1297.077187, -150), base_bearing_rad=-3.135013, spread_rad=0.069813, launch_delay_s=0.5, salvo_interval_s=2.0, u_boat_initial_speed_mps=2.0),
